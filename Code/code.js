...
Code.uploadClick = function(){
  ...
  alert("Readly to upload to Arduino.")
  Code.uploadCode(code, function(status, errotInfo){
      if (status == 200){
        alert("Program uploaded oK")
      } else {
        alert("Error uploading program" +  errotInfo)
      }
  })
};
