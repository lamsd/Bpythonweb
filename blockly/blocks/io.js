...
Blockly.Blocks['digital_read'] = {
  init: function() {
    ...
    this.setNextStatement(true, null);
    this.setColour(230);
 this.setTooltip("Chan_digital_pi");
 this.setHelpUrl("https://titkul.com/");
  },
  /**
   * Updates the content of the the pin related fields.
   * @this Blockly.Block
...
Blockly.Blocks['delay'] = {
  init: function() {
    ...
    this.setNextStatement(true, null);
    this.setColour(230);
 this.setTooltip("gia tri thoi gian");
 this.setHelpUrl("https://pypi.org/project/Keras/");
  }
};
